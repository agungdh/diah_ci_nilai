<div class="box box-primary">
  <div class="box-header with-border">
    <h4><strong><font color=blue>IMPORT DATA SISWA</font></strong></h4>
  </div><!-- /.box-header -->
  ...
  <form name="form" enctype="multipart/form-data" id="form" role="form" method="post" action="<?php echo base_url('siswa/aksi_impor'); ?>" >
    ...
    <div class="form-group">
          <a href="<?php echo base_url('berkas/template/siswa.xls'); ?>" class="btn btn-warning">Download template</a>
    </div>
    ...
    <div class="box-footer">
      ...
      <a href="<?php echo base_url('siswa/data_siswa'); ?>" class="btn btn-info">Batal</a>
    </div>
  </form>
</div><!-- /.box -->
