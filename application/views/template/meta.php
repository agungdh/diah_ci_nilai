    ...
    <meta name="keywords" content="Politeknik Negeri Lampung" />
    <meta name="author" content="Manajemen Informatika" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
  
    <link rel="shortcut icon" href="<?php echo base_url() . "assets/"; ?>logo.jpg" type="image/vnd.microsoft.icon">

    <title>App Nilai Akademik CAS</title>
    ...
    <script type="text/javascript" language="javascript" src="<?php echo base_url() . "assets/"; ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>
		<script type="text/javascript" language="javascript" src="<?php echo base_url() . "assets/"; ?>plugins/jQueryUI/jquery-ui.min.js"></script>  
