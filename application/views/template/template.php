            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="<?php echo base_url('upload/'.$this->session->id_user.'.jpg'); ?>" class="user-image" alt="User Image">
            ...
            echo "Hi " . $this->session->nama . " !!!";
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img src="<?php echo base_url('upload/'.$this->session->id_user.'.jpg'); ?>" class="img-circle" alt="User Image">
                    <p>
