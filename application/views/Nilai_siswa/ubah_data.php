<div class="box box-primary">
  ...
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('Nilai/update_data'); ?>" enctype="multipart/form-data" >
    <div class="box-body">
    <div class="row">
    <div class="col-md-6">
     <input type="hidden" class="form-control" id="id_nilai"  name="id_nilai" value="<?php echo $data_nilai->id_nilai;?>">
    <div class="form-group">
                <label for="nis">Nama Siswa</label>
                  <select name ="nis" type="text" class="form-control select2" style="width: 100%;">
                  <option value="<?php echo $data_nilai->nis;?>"><P><?php echo $data_nilai->nama;?></P></option>
                  <?php
    ...
    <div class="form-group">
       <label for="id_kelas">Kelas</label>
                  ...
                  <option value="<?php echo $data_nilai->id_kelas;?>"><P><?php echo $data_nilai->nama_kelas;?></P></option>
                  <?php
                  mysql_connect("localhost", "root","");
                  mysql_select_db("db_nilai");
    ...
    <div class="form-group">
      ...
      <option value="<?php echo $data_nilai->kode_mapel;?>"><P><?php echo $data_nilai->nama_mapel;?></P></option>
      <?php
      mysql_connect("localhost", "root","");
      mysql_select_db("db_nilai");
      ...
      <option value="<?php echo $data_nilai->id_semester;?>"><P><?php echo $data_nilai->semester;?></P></option>
      <?php
      mysql_connect("localhost", "root","");
      mysql_select_db("db_nilai");
      ...
      <label for="kategori_nilai">Kategori Nilai</label>
         <select name="kategori_nilai" id="kategori_nilai" class="form-control" >
              <option value="<?php echo $data_nilai->kategori_nilai;?>"><?php echo $data_nilai->kategori_nilai;?></option>
      ...
      <label for="nilai">Nilai</label>
          <input type="text" class="form-control" id="nilai" placeholder="Masukkan Nilai" name="nilai" required="required" value="<?php echo $data_nilai->nilai;?>">
      </div>
      <div class="form-group">
      <label for="tahun_ajar">Tahun Ajaran</label>
          <input type="text" class="form-control" id="tahun_ajar" placeholder="Masukkan Tahun Ajaran Siswa" name="tahun_ajar" required="required" value="<?php echo $data_nilai->tahun_ajar;?>">
      </div>
      </div>
    </div>
      </div>
